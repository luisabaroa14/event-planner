  ...
  const events = [
    {
      id: 1,
      name: "Event 1",
      image: "https://cdn.pixabay.com/photo/2015/12/26/11/08/finger-food-1108565_1280.jpg",
    ...
    },
    {
      id: 3,
      name: "Event 3",
      image: "https://media.post.rvohealth.io/wp-content/uploads/2022/09/frozen-dinner-meal-meatloaf-mashed-potatoes-vegetables-732x549-thumbnail-732x549.jpg",
      date: new Date(currentDate.setDate(currentDate.getDate() + 1))
        .toISOString()
        .split("T")[0],
      location: "Location 3",
    ...
    },
    {
      id: 4,
      name: "Event 4",
      image: "https://cdn.sanity.io/images/cctd4ker/production/9296da795070ca0b6d9147d9507ab54d9e2dba84-1440x960.jpg?w=3840&q=75&fit=clip&auto=format",
    ...
    },
    {
      id: 6,
      name: "Event 6",
      image: "https://ichef.bbci.co.uk/images/ic/832xn/p0h0ylf7.jpg",
      date: new Date(currentDate.setDate(currentDate.getDate() + 1))
        .toISOString()
        .split("T")[0],
      location: "Location 6",
    ...
    },
    {
      id: 7,
      name: "Event 7",
      image: "https://hips.hearstapps.com/hmg-prod/images/delish-221219-burger-king-chicken-fries-0133-eb-1672788323.jpg?crop=0.683xw:1.00xh;0.248xw,0&resize=640:*",
      date: new Date(currentDate.setDate(currentDate.getDate()))
        .toISOString()
        .split("T")[0],
      location: "Location 7",
...
export function getDishes() {
  const dishes = [
    ...
    },
    {
      ...
      cost: "59.77$",
      categoryId: 2,
      image: "https://images.ctfassets.net/awb1we50v0om/2Spf80TME2zIhLqsi3Zxv9/919421a45f3260ee426c99c35235f1c8/Plates03__3__copy3.jpg?w=1920&fm=webp&q=70",
      rating: 0,
    },
    {
      id: 4,
    ...
    },
    {
      ...
      cost: "59.77$",
      categoryId: 3,
      image: "https://fotografias.larazon.es/clipping/cmsimages01/2023/11/16/080445F5-DC20-409E-A8B9-498C90C12C90/dieta-mexicana-reduce-inflamacion-colesterol-malo-debido-sus-componentes_98.jpg?crop=1280,720,x0,y0&width=1900&height=1069&optimize=low&format=webply",
      rating: 0,
    },
    {
      id: 6,
    ...
    },
    {
      ...
      cost: "59.77$",
      categoryId: 1,
      image: "https://okdiario.com/image/2021/03/10/recetas-chinas-655x368.jpg",
      rating: 0,
    },
    {
      id: 8,
    ...
    },
    {
      ...
      cost: "59.77$",
      categoryId: 3,
      image: "https://cdn-ilaijbf.nitrocdn.com/YzeYmKigJpOUmEDUPOsqjcZLGXECGjCN/assets/images/optimized/rev-fee2c83/www.foodfood.com/wp-content/uploads/2024/05/PunjabiSamosa.jpg",
      rating: 0,
    },
    {
      id: 16,
  ...
  const chefs = [
    {
      ...
      image: "https://static.cordonbleu.edu/Files/MediaFile/79298.jpg",
    ...
    },
    {
      ...
      image: "https://static.cordonbleu.edu/Files/MediaFile/70795.jpg",
    ...
    },
    {
      ...
      image: "https://static.cordonbleu.edu/Files/MediaFile/80212.jpg",
